...
CATEGORY_ICONS = {
    ...
    "bus":            '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h8m-8 4h8m-4 8v2m-5-2h10M5 3h14a2 2 0 012 2v11a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z"/>',
    ...
    "car":            '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10l2 1h4m4-1l4 1m-4-1V8a1 1 0 011-1h2l3 4v5"/>',
    ...
    "user-check":     '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>',
    "coffee":         '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3v2m6-2v2M9 19H7a2 2 0 01-2-2V9a2 2 0 012-2h10a2 2 0 012 2v1m2 13H7m-2-8h14m-9 4h4"/>',
    ...
    "more-horizontal":'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z"/>',
    "repeat":         '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/>',
    ...
    "utensils":       '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 002-2V2M7 2v20M21 15V2a5 5 0 00-5 5v6c0 1.1.9 2 2 2h3zm0 0v5"/>',
    "baby":           '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 2a7 7 0 100 14A7 7 0 0012 2zm0 0v14m0-7h7M9 9h.01M15 9h.01M9.5 13a3.5 3.5 0 005 0"/>',
    "dumbbell":       '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 5v14M18 5v14M3 8h3M18 8h3M3 16h3M18 16h3M6 8h12v8H6z"/>',
    "pill":           '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.5 6h3M7 10.5v3M17 13.5v-3M13.5 17h-3M3.515 3.515A9 9 0 1020.485 20.485 9 9 0 003.515 3.515zm2.12 2.12l12.73 12.73"/>',
    "scissors":       '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 9a3 3 0 100-6 3 3 0 000 6zm0 6a3 3 0 100 6 3 3 0 000-6zm10-8.5L7.5 16M16.5 16L8 7.5M17 5l2.5 2.5L17 10"/>',
    "percent":        '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 5L5 19M6.5 6a.5.5 0 110-1 .5.5 0 010 1zm11 11a.5.5 0 110-1 .5.5 0 010 1z"/><circle cx="6.5" cy="5.5" r="2.5" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><circle cx="17.5" cy="18.5" r="2.5" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>',
    ...
    "truck":          '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10l2.5 1m7.5-1V8.5a1 1 0 011-1h2.5l2 3.5V16m-8 0h8"/>',
    "train":          '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 4h14a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2zm7 12l-2 3m2-3l2 3M4 11h16M9 4v7m6-7v7"/>',
    ...
    "compass":        '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.222 8.778l-4.808 2.02-2.02 4.808 4.808-2.02 2.02-4.808z"/>',
    # ── Moradia & Utilidades ───────────────────────────────────────────────────
    ...
    "umbrella":       '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12a9 9 0 0118 0M3 12h18M12 12v7m0 0c0 1.1-.9 2-2 2s-2-.9-2-2"/>',
    ...
    "folder":         '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7a2 2 0 012-2h3.172a2 2 0 011.414.586l.828.828A2 2 0 0011.828 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V7z"/>',
    # ── Pessoas & Social ──────────────────────────────────────────────────────
    ...
    "leaf":           '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16s1-1 4-1 5 2 8 2 4-1 4-1V4s-1 1-4 1-5-2-8-2-4 1-4 1v12zm0 0v4"/>',
    # ── Finanças & Análise ─────────────────────────────────────────────────────
    ...
    "wallet":         '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10a1 1 0 011-1h16a1 1 0 011 1v8a2 2 0 01-2 2H5a2 2 0 01-2-2v-8zm0 0V8a2 2 0 012-2h13.5M16 14h.01"/>',
...
AVAILABLE_ICONS = list(CATEGORY_ICONS.keys())


@register.simple_tag
def category_icon(icon_name, css_class="h-4 w-4"):
    inner = CATEGORY_ICONS.get(icon_name) or CATEGORY_ICONS["more-horizontal"]
    return mark_safe(
        f'<svg class="{css_class}" fill="none" stroke="currentColor" viewBox="0 0 24 24">'
        f'{inner}</svg>'
    )
